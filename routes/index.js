...
// Defina as configurações para o controle de acesso básico
const authConfig = {
  authorizer: async (username, password, cb) => {
    try {
      // Verifique as credenciais do usuário no banco de dados
      const user = await mongoRepository.getUserByUsername(username);
  ...
  challenge: true // Exiba uma caixa de diálogo para autenticação
};
